...
private:
	...
	void OnRightDeselected( wxListEvent& );
	void OnRightActivated( wxListEvent& );
	void OnLeftSelected( wxListEvent& );
	void OnLeftDeselected( wxListEvent& );
	void OnLeftActivated( wxListEvent& );
	void initListControls( const bool &useConfig );
