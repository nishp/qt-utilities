...
class MyTreeItemData: public wxClientData
{
...
public:
    ...
    MyTreeItemData *GetItemData(const wxTreeItemId& item) const;
    ...
    void SetItemData(const wxTreeItemId& item, MyTreeItemData *data);
...
class TreeWidget: public MyGenericTreeCtrl
{
